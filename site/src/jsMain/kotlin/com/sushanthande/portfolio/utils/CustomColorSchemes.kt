...
object CustomColorSchemes {
    val BlackAndWhite = object : ColorScheme {
        ...
        override val _500 = Color.rgb(0x022d53)
        override val _600 = Color.rgb(0x022d53)
        override val _700 = Color.rgb(0x022d53)
        override val _800 = Color.rgb(0x022d53)
        override val _900 = Color.rgb(0x022d53)
    }
}